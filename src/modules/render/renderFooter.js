...
const createFooterCategory = () => {
  ...
  for (const key in DATA.navigation) {
    ...
    }, {parent: footerCategoryList, append: createElement(
      'h3', 
      {
...
export const renderFooter = () => {
  ...
  container.insertAdjacentHTML('beforeend', `
          ...
          <h2 class="footer__title footer-category__title">Связаться с нами</h2>
          <p class="footer-social__subtitle">Контакты и адреса магазинов</p>

          <ul class="footer-social__list">
             <li class="footer-social__item">
               <a href="#" class="footer-social__link footer__link footer-social__link-fb">
        ...
        <div class="footer__item footer__item_contacts footer__contacts">
          <a class="footer__link" href="mailto:Inspired@gmail.com">Inspired@gmail.com</a>
          <a class="footer__link" href="mailto:87473787200">+7 747 378 72 00</a>
        </div>
        ...
        <div class="footer__item footer__item_development footer-development">
          <ul class="footer-development__list">
             <li class="footer-development__item">
               Designer: <a class="footer__link" href="https://t.me/Mrshmallowww">Anastasia Iliina</a>
             </li>
             <li class="footer-development__item">
              Developer: <a class="footer__link" href="https://t.me/Quper">Valery Pobelenskiy</a>
            </li>
          </ul>
        </div>
